...
class CameraFragment : Fragment() {
      ...
      { reader ->
        ...
        fragmentScope.launch(Dispatchers.IO) {
          if (currentImage == null) {
            ...
            Log.d(TAG, "Image available in queue: ${currentImage!!.timestamp}")
            ...
            if(currentImage != null) {
              ...
              var bitmapImage = BitmapFactory.decodeByteArray(imageBytes, 0, imageBytes.size, null)
             ...
             if (mirrored || rotation != 0) {
              ...
              fragmentScope.launch(Dispatchers.Main) {
                callback.onBitmapReceived(bitmapImage)
  ...
  companion object {
    private val TAG = "NST_CameraFragment"
